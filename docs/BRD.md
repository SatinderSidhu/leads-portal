...
| 3.5 | April 3, 2026 | Interactive dashboard (stats, needs attention, my tasks, pipeline, engagement metrics), task assignment on Next Steps (assignedToId, email notification, dashboard integration), collapsible sidebar with hover-expand | — |
| 3.6 | April 3, 2026 | Portfolio system: PortfolioService and PortfolioProject models, service detail with pitch scripts (email/phone/meeting) + URLs + documents + linked projects, project detail with technologies/client/demo/scripts, create/edit forms, sidebar nav | — |
| 3.7 | April 3, 2026 | Secure messaging (Message model, ChatWidget on customer portal, Messages section on admin lead detail, email notifications, read receipts), email drafts (save/update/load/delete multiple drafts per lead), aboutCompany field on leads | — |
| 3.8 | April 3, 2026 | NAICS 2022 industry classification (NaicsSector/NaicsSubsector models, 20 sectors + 96 subsectors, cascading dropdowns on lead detail, /naics-codes management page), Knowledge Base (KnowledgeArticle model, 12 default articles, Markdown rendering, search, categories, shareable slug URLs) | — |
...
| 4.7 | April 7, 2026 | Email template enhancements: Template Name label (internal reference), Industry text field, Industry Sector (NAICS dropdown), Industry Subsector (NAICS cascading dropdown) for categorizing templates by industry | — |
| 4.6 | April 7, 2026 | Portfolio project enhancements: Industry, Industry Sector (NAICS dropdown), Industry Subsector (NAICS dropdown), Portfolio URL at KITLabs, Customer Reviews URL, Additional Links, Demo Video URL moved to project section. Copy buttons on all URL fields for easy sharing | — |
| 4.5 | April 7, 2026 | Dashboard enhancements: column sorting (click headers, default by last updated), configurable page size (20/50/100, default 50), "Unassigned" filter option in Assigned To dropdown, lead detail right column reorder (email conversation, audit log, next steps), breadcrumb navigation fixes, Release History page, 8 new Knowledge Base articles, OpenAPI spec v4.6 | — |
