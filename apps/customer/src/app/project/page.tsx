        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-b-2xl rounded-tr-2xl shadow-2xl">
          {activeTab === "overview" && (
            <div className="p-8 md:p-10">
              {/* Project Info */}
              <div className="mb-6">
                <p className="text-sm font-medium text-indigo-600 uppercase tracking-wider mb-1">Your Project</p>
            ...
            <div className="p-8 md:p-10">
              <SowSection
                ...
                sows={lead.scopeOfWorks.map((s) => ({
                  ...
                  version: s.version,
                  fileName: s.fileName,
                  filePath: s.filePath.startsWith("/uploads/") ? `${adminBaseUrl}${s.filePath}` : s.filePath,
                  fileSize: s.fileSize,
                  fileType: s.fileType,
                  comments: s.comments,
