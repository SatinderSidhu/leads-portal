    ...
    <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-3 bg-white dark:bg-gray-900 text-gray-400">or register with email</span>
        </div>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <a href={loginUrl} className="text-[#01358d] dark:text-blue-400 font-medium hover:underline">
            Sign in
          </a>
        </p>
      </div>
