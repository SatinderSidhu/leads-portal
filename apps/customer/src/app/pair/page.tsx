  ...
  return (
    <PairShell>
      ...
      <div className="space-y-2">
        ...
        <a
          href={`/api/auth/linkedin?returnTo=${returnTo}`}
          className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-[#0a66c2] text-white font-medium text-sm hover:bg-[#084f99] transition"
        >
