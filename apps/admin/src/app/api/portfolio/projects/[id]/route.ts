...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const project = await prisma.portfolioProject.update({
    ...
    data: {
      ...
      ...(body.industrySector !== undefined && { industrySector: body.industrySector || null }),
      ...(body.industrySubsector !== undefined && { industrySubsector: body.industrySubsector || null }),
      ...
      ...(body.customerReviewUrl !== undefined && { customerReviewUrl: body.customerReviewUrl || null }),
      ...(body.additionalLinks !== undefined && { additionalLinks: body.additionalLinks }),
