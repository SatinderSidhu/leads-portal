...
export default function NewTemplatePage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">New Questionnaire Template</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6 space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Pre-SOW Discovery"
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            placeholder="Optional — explain when to use this template"
