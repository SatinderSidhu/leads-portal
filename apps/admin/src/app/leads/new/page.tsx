          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="flex-1 bg-gray-100 text-gray-700 py-2.5 rounded-lg font-medium hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition border border-gray-200"
              >
