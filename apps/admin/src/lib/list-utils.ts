...
export const FILTER_FIELD_OPTIONS = [
  ...
  { value: "source", label: "Lead Source", type: "select", options: ["MANUAL", "AGENT", "BARK", "LINKEDIN_SALES_NAV", "APOLLO", "LINKEDIN_COMPANY_PAGE", "REFERRAL", "WEBSITE", "COLD_OUTREACH", "EVENT", "OTHER"] },
